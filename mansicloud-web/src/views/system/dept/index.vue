  ...
  <div class="app-container">
    ...
    <el-dialog append-to-body :close-on-click-modal="false" :before-close="crud.cancelCU" :visible.sync="crud.status.cu > 0" :title="crud.status.title" width="500px">
      <el-form ref="form" inline :model="form" :rules="rules" size="small" label-width="80px">
        ...
        <el-form-item label="公司排序" prop="deptSort">
          <el-input-number
        ...
        <el-form-item v-if="form.isTop === '0'" style="margin-bottom: 0;" label="上级公司" prop="pid">
          <treeselect
            v-model="form.pid"
...
const defaultForm = { id: null, isDeleted: '0', name: null, isTop: '1', subCount: 0, pid: null, deptSort: 999, enabled: 'true' }
export default {
  name: 'Dept',
  components: { Treeselect, crudOperation, rrOperation, udOperation, DateRangePicker },
  cruds() {
    return CRUD({ title: '公司', url: 'api/dept', crudMethod: { ...crudDept }})
  },
  mixins: [presenter(), header(), form(defaultForm), crud()],
  dicts: ['dept_status', 'dept_isDeleted'],
  data() {
    return {
      depts: [],
      rules: {
  ...
  methods: {
    ...
    changeEnabled(data, val) {
      this.$confirm('此操作将 "' + this.dict.label.dept_status[val] + '" ' + data.name + '公司, 是否继续？', '提示', {
