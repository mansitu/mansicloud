 ...
 */
package cn.mansitu.modules.maint.service.impl;

import cn.hutool.core.date.DatePattern;
import cn.hutool.core.date.DateUtil;
import cn.mansitu.exception.BadRequestException;
import cn.mansitu.modules.maint.domain.App;
import cn.mansitu.modules.maint.domain.Deploy;
import cn.mansitu.modules.maint.domain.DeployHistory;
import cn.mansitu.modules.maint.domain.ServerDeploy;
import cn.mansitu.modules.maint.repository.DeployRepository;
import cn.mansitu.modules.maint.service.DeployHistoryService;
import cn.mansitu.modules.maint.service.DeployService;
import cn.mansitu.modules.maint.util.ExecuteShellUtil;
import cn.mansitu.modules.maint.util.ScpClientUtil;
import cn.mansitu.modules.maint.websocket.MsgType;
import cn.mansitu.modules.maint.websocket.SocketMsg;
import cn.mansitu.modules.maint.websocket.WebSocketServer;
import cn.mansitu.utils.*;
import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import cn.mansitu.modules.maint.service.ServerDeployService;
import cn.mansitu.modules.maint.service.dto.AppDto;
import cn.mansitu.modules.maint.service.dto.DeployDto;
import cn.mansitu.modules.maint.service.dto.DeployQueryCriteria;
import cn.mansitu.modules.maint.service.dto.ServerDeployDto;
import cn.mansitu.modules.maint.service.mapstruct.DeployMapper;
...
public class DeployServiceImpl implements DeployService {
	...
	private boolean checkFile(ExecuteShellUtil executeShellUtil, AppDto app) {
		...
		// 使用安全的命令执行方式，避免直接拼接字符串，https://github.com/elunez/mansicloud/issues/873
