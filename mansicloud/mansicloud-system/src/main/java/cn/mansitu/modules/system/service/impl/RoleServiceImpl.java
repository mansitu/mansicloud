...
import cn.mansitu.modules.security.service.UserCacheManager;
import cn.mansitu.modules.security.service.dto.AuthorityDto;
import cn.mansitu.modules.system.repository.RoleRepository;
import cn.mansitu.modules.system.repository.UserRepository;
import cn.mansitu.modules.system.service.mapstruct.RoleMapper;
import cn.mansitu.modules.system.service.mapstruct.RoleSmallMapper;
import cn.mansitu.utils.*;
import lombok.RequiredArgsConstructor;
import cn.mansitu.modules.system.domain.Menu;
import cn.mansitu.modules.system.domain.Role;
import cn.mansitu.modules.system.domain.User;
import cn.mansitu.modules.system.service.RoleService;
import cn.mansitu.modules.system.service.dto.RoleDto;
import cn.mansitu.modules.system.service.dto.RoleQueryCriteria;
import cn.mansitu.modules.system.service.dto.RoleSmallDto;
...
public class RoleServiceImpl implements RoleService {
    ...
    public List<RoleDto> queryAllWithLevelFilter(int currentLevel) {


        // 如果不是最高级别(level=1),则只返回级别低于当前用户的角色
        if (currentLevel != 1) {
            return roleMapper.toDto(roleRepository.findByLevelGreaterThan(currentLevel));
        }
